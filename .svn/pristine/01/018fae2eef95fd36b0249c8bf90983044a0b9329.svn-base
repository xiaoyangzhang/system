...
public class ServiceDetailDTO implements Serializable {
    ...
    private List<ServiceTaskLog> taskLogList = Collections.emptyList();
    ...
    private List<String> picUrls = Collections.emptyList();
...
//             return cardNo.replace(cardNo,cardNo.substring(0,cardNo.length()-4)+"****");
            return cardNo.replaceAll("(\\d{11,14})(\\d{3}[0-9Xx])","$1****");
        }
        return "";
    }
